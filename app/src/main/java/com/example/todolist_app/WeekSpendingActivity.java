        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    ...
                    totalAmount += total;
                    totalWeekAmountTextView.setText("Total Month's Spending: $"+df.format(totalAmount));
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()){
                    ...
                    totalAmount += total;
                    totalWeekAmountTextView.setText("Total Week's Spending: $"+df.format(totalAmount));
            }
            }
